...
model_dir = "regNetX"
comparison_report_path = "regNetX/comparison_report.txt"
...
# RegNetX-8GF model with task-specific heads and Dropout regularization
class RegNetXModel(nn.Module):
    def __init__(self, num_classes_super_class=2, num_classes_malignancy=3, num_classes_main_class_1=7,
        ...
        super(RegNetXModel, self).__init__()

        # Load pre-trained RegNetX-8GF
        self.base_model = regnet_x_8gf(weights=RegNet_X_8GF_Weights.IMAGENET1K_V2)
