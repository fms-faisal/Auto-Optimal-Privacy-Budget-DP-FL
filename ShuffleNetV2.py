...
model_dir = "shufflenetV2"
comparison_report_path = "shufflenetV2/comparison_report.txt"
...
# ShuffleNetV2 model with task-specific heads and Dropout regularization
...
def train_specific_model(train_loader, val_loader, device):
    ...
    # Model
    model = ShuffleNetV2Model().to(device)
