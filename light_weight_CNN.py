...
model_dir = "LightweightCustomConvModel"
comparison_report_path = "LightweightCustomConvModel/comparison_report.txt"
...
def train_specific_model(train_loader, val_loader, device):
    ...
    for epoch in range(1, 100):  # 20 epochs
        model.train()
        train_loss = 0
...
if __name__ == "__main__":
    ...
    model_manager.compare_models(
        model_class=LightweightCustomConvModel,
